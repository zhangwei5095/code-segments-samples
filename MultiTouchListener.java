...
import www.fqjj.net.imagespritefun.MainSprite;
import www.fqjj.net.imagespritefun.R;
...
public class MultiTouchListener implements OnTouchListener {
    ...
    public boolean onTouch(View view, MotionEvent event) {
      ...
      /*  if (view.getId() == R.id.image_panel) {
            view = MainSprite.currentView;
        }*/
